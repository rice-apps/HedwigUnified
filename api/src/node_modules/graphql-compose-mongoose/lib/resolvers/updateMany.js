...
function updateMany(model, // === MongooseModel
tc, opts) {
  ...
  const resolver = tc.schemaComposer.createResolver({
    ...
    type: outputType,
    args: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, (0, _helpers.recordHelperArgs)(tc, _objectSpread({
    ...
    }, opts && opts.sort))), (0, _helpers.skipHelperArgs)()), (0, _helpers.limitHelperArgs)(_objectSpread({}, opts && opts.limit))),
    resolve: async resolveParams => {
      ...
      if (resolveParams.query.updateMany) {
        resolveParams.query.updateMany({
          $set: (0, _toMongoDottedObject.toMongoDottedObject)(recordData)
        });
      } else {
        // OLD mongoose
