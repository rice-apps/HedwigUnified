...
import { GraphQLNonNull, getNamedType, GraphQLInt, GraphQLString, GraphQLList } from 'graphql-compose/lib/graphql';
...
describe('types/connectionType.js', () => {
  ...
  describe('prepareConnectionType()', () => {
    ...
    it('should have name ending with `OtherConnection` when passed lowercase otherConnection', () => {
      expect(prepareConnectionType(userTC, 'otherConnection').getTypeName()).toBe('UserOtherConnection');
    });
