import { SchemaComposer, schemaComposer, graphql, ObjectTypeComposer, InterfaceTypeComposer } from 'graphql-compose';
  ...
  describe('class methods', () => {
    ...
    describe('addNestedFields(newFields)', () => {
      ...
      it('should add field to baseTC', () => {
        expect(characterDTC.getFieldOTC('field1').getFieldType('nested')).toEqual(graphql.GraphQLString);
      });
      it('should add field to DInterface', () => {
        expect(characterDTC.getDInterface().getFieldOTC('field1').getFieldType('nested')).toEqual(graphql.GraphQLString);
      });
      it('should have exactly plus two fields added to childTC fields', () => {
        expect(droidTC.getFieldOTC('field1').getFieldType('nested')).toEqual(graphql.GraphQLString);
        expect(personTC.getFieldOTC('field2').getFieldType('nested')).toEqual(graphql.GraphQLString);
      });
