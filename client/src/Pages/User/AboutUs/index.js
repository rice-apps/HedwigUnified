...
const AboutUs = () => {
    ...
    return (
        <MainDiv>
            ...
            <PhotoGrid>
                <HeadShot src={Nikhita} name={"Nikhita Gangla"} position={"Project Manager"}/>
                <HeadShot src={Melinda} name={"Melinda Ding"} position={"Project Manager"}/>
            ...
            <DescriptionBlock>
                ...
                <GoalText>
                Hedwig is a web application built by RiceApps that enables members of the Rice community
                to order food for pickup on campus from Rice vendors such as Cohen House and East West Tea.
                In just a few clicks, any member of the Rice community can place an order for pickup, pay using
                credit card or Rice specific forms of payment such as Tetra or Cohen House Club Card, and receive 
                updates on its status in real-time. Similarly, vendors can view and interact with orders in real-time, 
                with a comprehensive order management solution backed by a powerful publicly-traded company.
                Hedwig currently only services breakfast and lunch from Cohen House Curbside at the Club. 
                </GoalText>
                <GoalTitle>Contact us</GoalTitle>
                <ContactText>
                    Contact us with any questions, feedbacks, or suggestions using this form: <br />
                    <a href="https://forms.gle/2ahMabUqo36P1ddh8 ">https://forms.gle/2ahMabUqo36P1ddh8</a>
                </ContactText>
            </DescriptionBlock>
        </MainDiv>
    );
