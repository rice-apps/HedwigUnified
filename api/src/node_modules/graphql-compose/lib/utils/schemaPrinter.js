...
function printScalar(type, options) {
  if (options === null || options === void 0 ? void 0 : options.omitScalars) return '';
...
function printArgs(_args, options, indentation = '') {
  ...
  const args = (options === null || options === void 0 ? void 0 : options.sortAll) || (options === null || options === void 0 ? void 0 : options.sortArgs) ? _args.sort((a, b) => a.name.localeCompare(b.name)) : _args; // If every arg does not have a description, print them on one line.
