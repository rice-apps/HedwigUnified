...
exports.countResolver = exports.findManyResolver = exports.userList = exports.UserTC = void 0;
...
const UserTC = _graphqlCompose.schemaComposer.createObjectTC(`
  type User {
    id: Int
    name: String
    age: Int
...
const findManyResolver = _graphqlCompose.schemaComposer.createResolver({
  name: 'findMany',
  kind: 'query',
  type: UserTC,
  args: {
    filter: filterArgConfig,
    sort: _graphqlCompose.schemaComposer.createEnumTC({
      name: 'SortUserInput',
      values: {
        ID_ASC: {
          value: {
...
exports.findManyResolver = findManyResolver;
UserTC.setResolver('findMany', findManyResolver);

const countResolver = _graphqlCompose.schemaComposer.createResolver({
  name: 'count',
  kind: 'query',
  type: 'Int',
  args: {
...
exports.countResolver = countResolver;
