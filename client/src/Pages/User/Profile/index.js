    ...
    return(    
        <div class="background">
            ...
            <div class="welcomebody">
                ...
                <h1 class="nametext"> name goes here <FontAwesomeIcon icon={["fas", "edit"]}/> </h1>
            ...
            <div class="contentbody">
                {links.map(link => (
                    <div class="contentcard">
                        <div class="contenticon"> <FontAwesomeIcon icon={["fas", link.icon]}/></div>
                        <p class="contenttitle">{link.content}</p>
                        {/* Checks if path exists, if not, then don't put an arrow */}
                        { link.path ? 
                            <button class="contentarrow" onClick={()=>window.open(link.path, "_self")}>
