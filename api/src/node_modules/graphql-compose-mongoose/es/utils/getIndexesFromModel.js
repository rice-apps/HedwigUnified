...
export function getIndexesFromModel(mongooseModel, opts = {}) {
...
export function getUniqueIndexes(mongooseModel) {
  const indexedFields = []; // add _id field if existed
...
export function extendByReversedIndexes(indexes, opts = {}) {
...
export function getIndexedFieldNamesForGraphQL(model) {
