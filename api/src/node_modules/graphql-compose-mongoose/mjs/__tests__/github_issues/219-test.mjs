  ...
  it('correct request', async () => {
    UserTC.wrapResolverResolve('findOne', next => rp => {
      rp.beforeQuery = async query => {
        ...
        if ((rp == null ? void 0 : (_rp$args = rp.args) == null ? void 0 : (_rp$args$filter = _rp$args.filter) == null ? void 0 : _rp$args$filter.name) === 'CACHED') {
          return {
            name: 'CACHED',
            age: 99
          };
        ...
        if ((rp == null ? void 0 : (_rp$args2 = rp.args) == null ? void 0 : (_rp$args2$filter = _rp$args2.filter) == null ? void 0 : _rp$args2$filter.name) === 'ERROR') {
    ...
    expect(await graphql.graphql(schema, `query {
