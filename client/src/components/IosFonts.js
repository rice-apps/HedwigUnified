  ...
  render () {
    return (
      <ScrollView style={styles.scroller}>
        ...
        <Text style={{ fontFamily: 'ArialHebrew-Bold' }}>
          ArialHebrew-Bold{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'AvenirNext-Heavy' }}>
          AvenirNext-Heavy{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Bangla Sangam MN' }}>
          Bangla Sangam MN{' '}
        </Text>
        <Text style={{ fontFamily: 'Baskerville' }}>Baskerville </Text>
        <Text style={{ fontFamily: 'Baskerville-Bold' }}>
          Baskerville-Bold{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Bodoni Ornaments' }}>
          Bodoni Ornaments{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Copperplate-Bold' }}>
          Copperplate-Bold{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'DamascusSemiBold' }}>
          DamascusSemiBold{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'GujaratiSangamMN' }}>
          GujaratiSangamMN{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Menlo-BoldItalic' }}>
          Menlo-BoldItalic{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Noteworthy-Light' }}>
          Noteworthy-Light{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'PingFangHK-Light' }}>
          PingFangHK-Light{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'PingFangSC-Light' }}>
          PingFangSC-Light{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'PingFangTC-Light' }}>
          PingFangTC-Light{' '}
        </Text>
        ...
        <Text style={{ fontFamily: 'Telugu Sangam MN' }}>
          Telugu Sangam MN{' '}
        </Text>
