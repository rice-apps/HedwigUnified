...
describe('Resolver helper `filter` ->', () => {
  ...
  describe('filterHelperArgs()', () => {
    ...
    it('should return filter field', () => {
      ...
      expect(args.filter.type).toBeInstanceOf(_graphqlCompose.InputTypeComposer);
    });
    it('should return filter with field _ids', () => {
      ...
      expect(ft).toBeInstanceOf(_graphqlCompose.ListComposer);
    ...
    it('should for opts.isRequired=true return GraphQLNonNull', () => {
      ...
      expect(args.filter.type).toBeInstanceOf(_graphqlCompose.NonNullComposer);
    });
    ...
    it('should set required fields via opts.requiredFields', () => {
      ...
      const itc = args.filter.type;
      expect(itc.getField('name').type).toBeInstanceOf(_graphqlCompose.NonNullComposer);
      expect(itc.getField('age').type).toBeInstanceOf(_graphqlCompose.NonNullComposer);
      expect(itc.getField('gender').type).not.toBeInstanceOf(_graphqlCompose.NonNullComposer);
    });
  ...
  describe('filterHelper()', () => {
    ...
    beforeEach(() => {
      ...
      spyFindFn = jest.fn();
      resolveParams = {
        query: _objectSpread(_objectSpread({}, _userModel.UserModel.find()), {}, {
          where: spyWhereFn,
          find: spyFindFn
        })
      };
