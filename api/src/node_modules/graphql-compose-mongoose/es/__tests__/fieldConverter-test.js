...
import { deriveComplexType, getFieldsFromModel, convertFieldToGraphQL, ComplexTypes, scalarToGraphQL, arrayToGraphQL, embeddedToGraphQL, enumToGraphQL, documentArrayToGraphQL, referenceToGraphQL, convertModelToGraphQL } from '../fieldsConverter';
...
describe('fieldConverter', () => {
  ...
  describe('enumToGraphQL()', () => {
    ...
    it('should work for Enums with keys preparation', () => {
      const model = mongoose.model('EnumTest', mongoose.Schema({
        oc: {
          type: String,
          enum: ['ocpp1.6', 'ocpp2.0']
        }
      }));
      const flds = getFieldsFromModel(model);
