...
describe('connectionResolver', () => {
      ...
      describe('HasPreviousPage', () => {
        it('If first is set (and after is empty), return false.', () => {
          expect((0, _connectionResolver.preparePageInfo)(fiveEdges, {
            first: 4
          }, 4, 0).hasPreviousPage).toBe(false);
        });
        it('If first is set (and after is present), return true.', () => {
          expect((0, _connectionResolver.preparePageInfo)(fiveEdges, {
            first: 4,
            after: 'abc'
          }, 4, 0).hasPreviousPage).toBe(true);
        });
  ...
  describe('edges with data', () => {
    const edgeDataResolver = (0, _connectionResolver.prepareConnectionResolver)(_userTC.userTC, {
      countResolverName: 'countThroughLink',
      findResolverName: 'findManyThroughLink',
      sort: _userTC.sortOptions,
      defaultLimit: 5,
      edgeFields: _userTC.userLinkTC.getFields()
    });
