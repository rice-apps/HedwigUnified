...
import { upperFirst, ObjectTypeComposer } from 'graphql-compose'; // PaginationInfo should be global
...
`);
export function preparePaginationInfoTC(sc) {
...
export function preparePaginationTC(tc, resolverName) {
